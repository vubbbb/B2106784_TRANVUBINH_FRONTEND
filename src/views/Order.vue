        ...
        <template v-slot:item="props">
          <div class="q-pa-xs col-xs-12 col-sm-6 col-md-4 col-lg-3 grid-style-transition">
            <q-card bordered flat>
              <q-card-section>
                <q-btn v-if="props.row.status ==='approved'" label="Complete" color="green" @click="completedOrder(props.row._id)" />
                <q-btn v-if="props.row.status ==='approved'" label="Reject" color="negative" @click="rejectOrder(props.row._id)" class="q-ml-md" />
